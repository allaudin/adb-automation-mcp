...
**52 tools.** Full signatures, docstrings, and worked examples are in the
...
| `packages` (5) | `list_packages`, `install_apk`, `uninstall_package`†, `install_existing_for_user`, `get_package_path` |
