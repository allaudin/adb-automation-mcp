...
adb_automation_mcp.modules:device_info at MODULE below, which the registry discovers and
...
from adb_automation_mcp.modules.device_info.tools import list_connected_devices
