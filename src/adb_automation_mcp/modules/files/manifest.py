...
adb_automation_mcp.modules:files at MODULE below, which the registry discovers and
...
def _service_factory(backend: AdbBackend) -> FilesService:
    # ADB_AUTOMATION_LOCAL_ROOT gates pull_file's host-file write — read here (not
