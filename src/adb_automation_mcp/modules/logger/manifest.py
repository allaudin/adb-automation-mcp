...
adb_automation_mcp.modules:logger at MODULE below, which the registry discovers and
...
from adb_automation_mcp.modules.logger.service import LoggerService
from adb_automation_mcp.modules.logger.tools import (
    clear_logs,
    get_log_buffer_size,
    read_logs,
    read_package_logs,
...
def _service_factory(backend: AdbBackend) -> LoggerService:
    # ADB_AUTOMATION_LOCAL_ROOT gates stop_log_session's host-file write — read here
