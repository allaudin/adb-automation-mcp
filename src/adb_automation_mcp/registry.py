...
from adb_automation_mcp.responses import ToolError, ToolResponse
...
ENTRY_POINT_GROUP = "adb_automation_mcp.modules"
...
def discover_modules() -> list[ModuleManifest]:
    """Load every ModuleManifest registered under the adb_automation_mcp.modules entry_point
