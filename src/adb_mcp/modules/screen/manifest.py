...
adb_mcp.modules:screen at MODULE below, which the registry discovers and
...
from adb_mcp.modules.screen.tools import take_screenshot
from adb_mcp.registry import ModuleManifest


def _service_factory(backend: AdbBackend) -> ScreenService:
    # ADB_MCP_LOCAL_ROOT gates take_screenshot's host-file write — read here
    ...
    # concern, same as logger's stop_log_session and files' pull_file. No
    # default: unset means take_screenshot refuses to run.
