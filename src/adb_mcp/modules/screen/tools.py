...
from adb_mcp.modules.screen.service import ScreenService, TakeScreenshotResult
    ...
    Example:
        ...
        ```json
        {
          ...
          "data": {
            ...
            "height": 2400,
            "size_bytes": 843221,
            "output": "/data/local/tmp/adb_mcp_screenshot_....png: 1 file pulled, 0 skipped. 4.2 MB/s (843221 bytes in 0.191s)\\n"
          },
          "error": null
        }
        ```
